...
/**
 * This class represents a node in an LSTM (Long Short-Term Memory) model.
 */
public class LSTMNode{
    ...
    /**
     * This constructor initializes the LSTM node with the given LSTM state and parameters.
     *
     * @param state The LSTM state.
     * @param param The LSTM parameters.
     */
    ...
    /**
     * This method sets the bottom data for the LSTM node.
     *
     * @param x       The input data.
     * @param s_prev  The previous state.
     * @param h_prev  The previous output.
     */
    ...
    /**
     * This method sets the top difference for the LSTM node.
     *
     * @param top_diff_h The top difference for h.
     * @param top_diff_s The top difference for s.
     */
